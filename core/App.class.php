...
class App {
    ...
    public static function &getSmarty(): \Smarty {
        if (!isset(self::$smarty)) { //Create smarty and assign configuration and messages
            require_once self::$config->root_path . '/libs/smarty/Smarty.class.php';
            ...
            self::$smarty->assign('rolesFromDatabase', RoleUtils::getRolesFromDatabase());
    ...
    public static function &getDB(): \Medoo\Medoo {
        if (!isset(self::$db)) {
            require_once self::$config->root_path . '/libs/medoo/Medoo.php';
